...
class CaloriesTrackerTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    lazy var fetchedResultsController: NSFetchedResultsController<Calories> = {
        ...
        fetchRequest.sortDescriptors = [NSSortDescriptor(key: "added", ascending: true), NSSortDescriptor(key: "added", ascending: true)]
    ...
    @IBAction func addCaloriesButton(_ sender: UIBarButtonItem) {
        let alertController = UIAlertController(title: "Add Calories", message: "Enter the amount of calories in the text field", preferredStyle: .alert)
